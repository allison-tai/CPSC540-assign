load MNIST.mat
%% data is in the array correct. Just set another array equal to correct then run again with other methods
[m n N] = size(images);
...
%[X samplabel] = insert barycenter method for sampling here
